...
export class SynergyComponent implements OnInit {
  ...
  championListForDisplay: ChampionModel[] = new Array<ChampionModel>(
    this.MAXIND
  );
  ...
  ngOnInit() {
    ...
    this.championService
      .getAllChampions()
      .subscribe((data: ChampionModel[]) => {
        this.championList = data;
        for (var i = 0; i < this.MAXCHAMPS; i++) {
          this.championListForDisplay[
            this.championList[i].id
          ] = this.championList[i];
        }
      });
  ...
  search() {
    ...
    if (this.teamValid) {
      ...
      this.matchService
        .getMatch(this.teamCode1, this.teamCode2)
        .subscribe((data: MatchModel) => {
          ...
          this.GetSuggestionInfo(
            this.matchdata.suggestion0,
            this.suggestion0,
            this.suggestion0Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion1,
            this.suggestion1,
            this.suggestion1Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion2,
            this.suggestion2,
            this.suggestion2Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion3,
            this.suggestion3,
            this.suggestion3Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion4,
            this.suggestion4,
            this.suggestion4Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion5,
            this.suggestion5,
            this.suggestion5Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion6,
            this.suggestion6,
            this.suggestion6Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion7,
            this.suggestion7,
            this.suggestion7Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion8,
            this.suggestion8,
            this.suggestion8Worst
          );
          this.GetSuggestionInfo(
            this.matchdata.suggestion9,
            this.suggestion9,
            this.suggestion9Worst
          );

          this.suggestion0.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion1.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion2.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion3.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion4.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion5.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion6.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion7.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion8.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );
          this.suggestion9.sort(
            (a, b) => (a.Win > b.Win ? -1 : a.Win < b.Win ? 1 : 0)
          );

          this.suggestion0Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion1Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion2Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion3Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion4Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion5Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion6Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion7Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion8Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
          this.suggestion9Worst.sort(
            (a, b) => (a.Loss > b.Loss ? -1 : a.Loss < b.Loss ? 1 : 0)
          );
  ...
  GetSuggestionInfo(
    input: string,
    suggestionArray: SuggestionModel[],
    suggestionArrayWorst: SuggestionModel[]
  ) {
    this.status = 0;
    this.champId = 0;
    ...
    if (input != null) {
      while (this.indexPosition < input.length) {
        if ("0123456789".indexOf(input[this.indexPosition]) !== -1) {
          ...
          this.suggestionModel.Winrate = Math.round(
            (this.win / (this.win + this.loss)) * 100
          );
